...
/* harmony import */ var _hmbd_hmbd_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./hmbd/hmbd.component */ "./src/app/hmbd/hmbd.component.ts");
...
/* harmony import */ var _hmbd_hmbd_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./hmbd/hmbd.component */ "./src/app/hmbd/hmbd.component.ts");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_6__["AppComponent"], _home_home_component__WEBPACK_IMPORTED_MODULE_9__["HomeComponent"], _hmbd_hmbd_component__WEBPACK_IMPORTED_MODULE_10__["HmbdComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
        _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_3__["BrowserAnimationsModule"],
        _app_routing_module__WEBPACK_IMPORTED_MODULE_5__["AppRoutingModule"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"],
        primeng_table__WEBPACK_IMPORTED_MODULE_8__["TableModule"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HmbdService", function() { return HmbdService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
HmbdService.ɵfac = function HmbdService_Factory(t) { return new (t || HmbdService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"])); };
HmbdService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: HmbdService, factory: HmbdService.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HmbdService, [{
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HmbdComponent", function() { return HmbdComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var primeng_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! primeng/utils */ "./node_modules/primeng/__ivy_ngcc__/fesm2015/primeng-utils.js");
/* harmony import */ var _hmbd_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../hmbd.service */ "./src/app/hmbd.service.ts");
...
function HmbdComponent_ng_template_15_th_1_p_sortIcon_2_Template(rf, ctx) { if (rf & 1) {
...
function HmbdComponent_ng_template_15_th_1_Template(rf, ctx) { if (rf & 1) {
...
function HmbdComponent_ng_template_15_th_3_input_1_Template(rf, ctx) { if (rf & 1) {
    const _r12 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "input", 16);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("input", function HmbdComponent_ng_template_15_th_3_input_1_Template_input_input_0_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r12); const col_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit; _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2); const _r0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](14); return _r0.filter($event.target.value, col_r9.field, "contains"); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
...
function HmbdComponent_ng_template_15_th_3_Template(rf, ctx) { if (rf & 1) {
...
function HmbdComponent_ng_template_15_Template(rf, ctx) { if (rf & 1) {
...
function HmbdComponent_ng_template_16_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "tr");
...
class HmbdComponent {
    constructor(hmbdService) {
        this.hmbdService = hmbdService;
        // on startup: load database from server and show salmonella
        this.setup();
        this.getSalmonella();
        this.getEscherichia();
        this.getKlebsiella();
    ...
    ngOnInit() {
        ...
        this.cols = [
            { field: 1, sortIcon: false, header: 'Metal', class: 'row-1' },
            { field: 2, sortIcon: true, header: 'Gene', class: 'row-2' },
            { field: 3, sortIcon: false, header: 'ID', class: 'row-3' },
            {
                field: 4,
                sortIcon: true,
                header: 'Description',
            ...
            { field: 5, sortIcon: false, header: 'Accession', class: 'row-5' },
            {
                field: 6,
                sortIcon: false,
            ...
            { field: 7, sortIcon: false, header: 'Pubmed', class: 'row-7' },
            { field: 8, sortIcon: false, header: 'NCBI Gene', class: 'row-8' },
            {
                field: 9,
                sortIcon: false,
                header: 'Location',
        ...
        primeng_utils__WEBPACK_IMPORTED_MODULE_1__["FilterUtils"]['custom'] = (value, filter) => {
    ...
    setup() {
        this.hmbdService.getSalmonella().subscribe((data) => {
            this.table = data;
        }, (error) => {
    ...
    getEscherichia() {
        this.hmbdService.getEscherichia().subscribe((data) => {
            this.escherichia = data;
        }, (error) => {
    ...
    getKlebsiella() {
        this.hmbdService.getKlebsiella().subscribe((data) => {
            this.klebsiella = data;
        }, (error) => {
...
HmbdComponent.ɵfac = function HmbdComponent_Factory(t) { return new (t || HmbdComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_hmbd_service__WEBPACK_IMPORTED_MODULE_2__["HmbdService"])); };
HmbdComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HmbdComponent, selectors: [["app-hmbd"]], decls: 20, vars: 4, consts: [[1, "jumbotron", "jumbotron-fluid"], [1, "container"], [1, "display-4"], [1, "table-tab", "bg-light"], [3, "click"], [1, "table"], [3, "columns", "value", "paginator", "rows"], ["dt", ""], ["pTemplate", "header"], ["pTemplate", "body"], [3, "pSortableColumn", "class", 4, "ngFor", "ngForOf"], [4, "ngFor", "ngForOf"], [3, "pSortableColumn"], [3, "field", 4, "ngIf"], [3, "field"], ["pInputText", "", "type", "text", 3, "class", "input", 4, "ngIf"], ["pInputText", "", "type", "text", 3, "input"], ["target", "_blank", 3, "href"]], template: function HmbdComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HmbdComponent_Template_button_click_6_listener() { return ctx.showSalmonella(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](7, "Metal 1");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](8, "button", 4);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HmbdComponent_Template_button_click_8_listener() { return ctx.showEscherichia(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](9, "Metal 2");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](10, "button", 4);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HmbdComponent_Template_button_click_10_listener() { return ctx.showKlebsiella(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HmbdComponent, [{
    ...
    }], function () { return [{ type: _hmbd_service__WEBPACK_IMPORTED_MODULE_2__["HmbdService"] }]; }, null); })();
...
HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HomeComponent, selectors: [["app-home"]], decls: 5, vars: 0, consts: [[1, "jumbotron", "jumbotron-fluid"], [1, "container"], [1, "display-4"], [1, "lead"]], template: function HomeComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "h1", 2);
...
module.exports = __webpack_require__(/*! C:\Users\ykwon\Desktop\vscode-first-test\ui\src\main.ts */"./src/main.ts");
